...
describe('Gameplay', () => {
  ...
  it('Users cannot play any turns once a game is won or tied', () => {
    ...
    // had to change this to expect turn to equal 0
    // according to specs and the test above (line 244), once a win occurs the game
    // should immediately reset, not retain the previous turn count
    expect(window.turn).to.equal(0);
  });
